...
from qd_server.api.data_management import router as data_management_router
...
api_router.include_router(data_management_router, prefix="/data", tags=["Data Management"])
